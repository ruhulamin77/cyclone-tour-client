...
const AddTour = () => {
    ...
    const onSubmit = data => {
        console.log(data);
        axios.post('https://ghoulish-barrow-11758.herokuapp.com/tours', data)
            .then(res => {
        ...
        <Container >
            <div className="add-tour my-5">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="add-tour-form">
                    ...
                    <textarea className="description-field" {...register("description", { required: true })} placeholder="Tour Description" />
